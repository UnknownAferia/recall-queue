...
export const CommunityCustomIds = Object.freeze({
  ...
  squad: {
    create: "community:squad:create",
    createModal: "community:squad:create:submit",
    edit: "community:squad:edit",
    editModal: "community:squad:edit:submit",
    join: "community:squad:join",
    joinModal: "community:squad:join:submit",
    refresh: "community:squad:refresh",
    manage: "community:squad:manage",
    back: "community:squad:back",
    recruitingRoles: "community:squad:recruiting-roles",
    closeRecruitment: "community:squad:close-recruitment",
    regenerateInvite: "community:squad:regenerate-invite",
    applyFounding: "community:squad:apply-founding",
    kickMember: "community:squad:kick-member",
    transferCaptain: "community:squad:transfer-captain",
    leaveReview: "community:squad:leave:review",
    leaveConfirm: "community:squad:leave:confirm",
    disbandReview: "community:squad:disband:review",
    disbandConfirm: "community:squad:disband:confirm",
    cancel: "community:squad:cancel",
    inputs: {
      name: "community:squad:input:name",
      tag: "community:squad:input:tag",
      region: "community:squad:input:region",
      description: "community:squad:input:description",
      inviteCode: "community:squad:input:invite-code",
    },
  },
});
